...
def update(dt):
    ...
    '''
    if len(ball.trail_object.projected)> 0:
        print("ball pos: ", ball.pos, "last trail projected point: ",
          ball.trail_object.projected[-1])
    '''
...
vrun(update, render_images=False, max_frames=101, interval=1)
