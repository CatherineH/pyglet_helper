...
_pyramid = Pyramid(pos=(1, -1, 0), length=1.0, height=1.0, width=1.0,
                   color=color.CYAN)
...
_ring = Ring(pos=(0, -1, 0), axis=(0, 1, 0), radius=0.5, thickness=0.1,
             color=color.MAGENTA)
_ellipsoid = Ellipsoid(pos=(-1, -1, 0), length=0.75, height=0.5, width=0.75,
                       color=color.GREEN)
_cylinder = Cylinder(pos=(1, 0, 0), axis=(0.3, 0, 0), radius=0.4,
                     color=color.ORANGE)
